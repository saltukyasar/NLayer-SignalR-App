...
namespace SignalRWebUI.Controllers
{
	public class ProductController : Controller
	{
		...
		{
			var client = _httpClientFactory.CreateClient();
			var responseMessage = await client.DeleteAsync($"https://localhost:7252/api/Product/{id}");
		...
		public async Task<IActionResult> UpdateProduct(int id)
		{
			...
			var responseMessage1 = await client1.GetAsync("https://localhost:7252/api/Category");
			...
			var client = _httpClientFactory.CreateClient();
			var responseMessage = await client.GetAsync($"https://localhost:7252/api/Product/{id}");
